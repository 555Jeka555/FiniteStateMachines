...
expressions = [
    ...
    Expression([SpacesToken, IDToken, ColonToken, SpaceToken, ArrayTypeToken, LeftBracketToken, IntegerToken, DotToken, DotToken, IntegerToken, RightBracketToken, SpaceToken, OfToken, SpaceToken, TypeToken, EndLineToken]),
